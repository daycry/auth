...
<head>
    ...
    <title><?= lang('Auth.passwordResetSubject') ?></title>
</head>
        ...
        <tbody>
            <tr>
                <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="#0d6efd">
                    <a href="<?= site_url('password-reset/verify?token=' . $token) ?>" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;"><?= lang('Auth.passwordResetButton') ?></a>
                </td>
            </tr>
        </tbody>
    </table>
