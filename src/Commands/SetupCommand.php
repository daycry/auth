...
use Config\Services;
use Daycry\Auth\Commands\Setup\ContentReplacer;
...
class SetupCommand extends BaseCommand
{
     ...
     * @var string
     */
    protected $description = 'Initial setup for CodeIgniter Auth.';
    ...
    /**
     * The path to `Daycry\Auth\` src directory.
     *
     * @var string
     */
    ...
    private function publishConfigAuth(): void
    {
        ...
        $replaces = [
            ...
            'use CodeIgniter\\Config\\BaseConfig;' => 'use Daycry\\Auth\\Config\\Auth as BaseAuth;',
            'extends BaseConfig'                   => 'extends BaseAuth',
        ];
